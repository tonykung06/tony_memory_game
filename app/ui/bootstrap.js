...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "MemoryGame.controller.GameBoard": [],
  "MemoryGame.controller.Main": [],
  "MemoryGame.model.HighScore": [],
  "MemoryGame.plugin.GridTooltip": [],
  "MemoryGame.store.HighScores": [],
  "MemoryGame.util.Resource": [],
  "MemoryGame.view.GameBoard": [],
  "MemoryGame.view.Main": [],
  "MemoryGame.view.Viewport": []
});
